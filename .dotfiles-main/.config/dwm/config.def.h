...
static const char *upbright[]   = { "changebrightness", "up",		NULL };
static const char *downbright[] = { "changebrightness", "down", 	NULL };
static const char *uslayout[] 	= { "setxkbmap", 	"us", 		NULL };
static const char *bglayout[] 	= { "setxkbmap", 	"bg(phonetic)", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,              		XK_b,  	    	shiftview,      {.i = -1 } },
    	...
    	{ MODKEY,                       XK_F11,    	spawn,          {.v = uslayout} },
    	{ MODKEY,                       XK_F12,    	spawn,          {.v = bglayout} },
    	{ MODKEY,                       XK_F8,    	spawn,          {.v = wifimenu} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
